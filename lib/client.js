  ...
  factory: (require) => {
    ...
    function SettingsCard() {
      ...
      return react.createElement("div", { style: { padding: "8px 0", fontSize: 13 } },
        react.createElement("div", { style: { color: "var(--dsw-alias-label-primary)", marginBottom: 6, fontSize: 13 } },
          "外置盘白名单"),
        react.createElement("div", { style: { color: "var(--dsw-alias-label-tertiary)", fontSize: 12, marginBottom: 8, lineHeight: "18px" } },
          "会话工作目录之外的路径（外置盘、~/Desktop 等）加进来后可显示并点击打开；每行一个目录。系统盘特征目录（/System、/etc）会被自动拒绝。"),
        react.createElement("textarea", {
          ...
          style: {
            ...
            fontFamily: "monospace", color: "var(--dsw-alias-text-secondary, #666)",
            background: "var(--dsw-alias-interactive-bg, rgba(0,0,0,0.04))",
        ...
        react.createElement("div", { style: { display: "flex", alignItems: "center", gap: 10, marginTop: 8 } },
          react.createElement("button", {
            ...
            style: {
              ...
              color: "var(--dsw-alias-text-secondary, #666)", borderRadius: 6, cursor: "pointer",
              fontSize: 12, lineHeight: "20px", padding: "0 12px",
            },
          }, saving ? "保存中…" : "保存"),
          msg !== "" && react.createElement("span", { style: { color: "var(--dsw-alias-text-tertiary, #999)", fontSize: 12 } }, msg)),
      );
    }
    ...
    function apply(ctx) {
      ...
      slots.inject("settings.section", () => slots.register(
        { name: "settings.section", id: "file-mentions-settings", order: 40, label: "文件提及" },
